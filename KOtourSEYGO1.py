...
For details on usage comment/uncomment sequentially sections of code below. 
Likewise, check the methods in KOtourSEYGOdefinitions.py
'''

# load('KOtourSEYGOdefinitions.sage')  # load definitions
from KOtourSEYGOdefinitions import *
################################################################
